...
func TestArrayList(t *testing.T) {
	...
	var f1 = Element("bam", Id("097"))
	_, err = list.Add(f1)
	require.NoError(t, err)

	var f2 = Element("cam", Id("y676"))
	_, err = list.Add(f2)
	require.NoError(t, err)

	var f3 = Element("yam", Id("5445"))
	_, err = list.Add(f3)
	require.NoError(t, err)
	...
	var f4 = Element("vam", Id("67"))
	_, err = list.Add(f4)
	require.NoError(t, err)

	var f5 = Element("gam", Id("98"))
	_, err = list.Add(f5)
	require.NoError(t, err)

	var f6 = Element("iam", Id("7676"))
	_, err = list.Add(f6)
	require.NoError(t, err)
